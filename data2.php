<!-- <?php
        ...
        $Prod_Banner = array(
            '0' => array(
                ...
                'image-mob' => "images/product-banner/mob/Jaw-Crushers-400x300.webp",
            ...
            '1' => array(
                'image' => "images/product-banner/core-cone-crusher-1.webp",
                'image-mob' => "images/product-banner/mob/core-cone-crusher.webp",
                'title' => "Cone Crushers ", 'subtitle' => "Welcome to Crusher Solutions, where industry-leading innovation meets unparalleled performance. ",
                'description' => 'Our comprehensive range of crushers, meticulously designed for various applications, promises exceptional efficiency and reliability. 
            With a steadfast commitment to quality and cutting-edge technology, we empower businesses to elevate their material processing endeavours. Explore our array of premium crushers today and experience the pinnacle of productivity and precision in crushing technology. '
            ),
            '2' => array('image' => "images/product-banner/Sand-cone-1.webp",
            'image-mob' => "images/product-banner/mob/Sand Plant-400x300.webp",
            'title' => "SANDER CONE",  'subtitle' => "SPECIALLY DESIGNED TO MAXIMIZE SAND PRODUCTION.
            ...
            '3' => array(
                'image' => "images/product-banner/Vertical-Shaft-Impact-Crusher-2.webp",
                'image-mob' => "images/product-banner/mob/Vertical-Shaft-Impact-Crushe-400x300.webp",
                'title' => "OUR VSI IS DESIGNED TO PRODUCE HIGH-QUALITY",
            ...
            '4' => array(
                'image' => "images/product-banner/HFS-1.webp",
                'image-mob' => "images/product-banner/mob/HSF-400x300 copy.webp",
                'title' => " HFS High Frequency Screens",
            ...
            '5' => array(
                'image' => "images/product-banner/Grizzly-Feeder-2.webp",
                'image-mob' => "images/product-banner/mob/Grizzly-Feeder-400x300.webp",
            ...
            '6' => array(
                'image' => "images/product-banner/Vibrating-screen.webp",
                'image-mob' => "images/product-banner/mob/core-cone-crusher.webp",
                'title' => " Vibrating Screen ",
                'subtitle' => "Innovative vibrating screens for efficient material handling.",
        ...
        $successInEveryHardness = array(
            ...
            '1' => array(
                'successContent' => "Core's SH Cone Crushers: Optimized for superior performance and durability in versatile crushing applications.",
                'vimage' => "images/leftsideproduct/Core-Cone-Crushing-LH-200.webp",
                'vimage2' => "images/leftsideproduct/Core-Cone-Crushing-SH400.webp",

                // "h1" => "Anti Friction Roller Bearings:",
                // "d1" => "Minimize frictional losses for enhanced crushing power.",
                // "h2" => "Efficient Motor Usage:",
                // "d2" => "Operates with a 37 kW motor, ensuring ample power for crushing.",
                "h1" => "Cartridge-Type Design:",
                "d1" => "Allows easy access for inspection and servicing of components.",
                "h2" => "Compact and Balanced:",
                "d2" => "The counterbalance mechanism reduces out-of-balance forces, ensuring stability.",
                "h3" => "Speed Flexibility:",
                "d3" => "Roller bearing design enables flexible speed operation without limitations.",
                "h4" => "High Productivity:",
                "d4" => "Versatile usage options for secondary, tertiary, or quaternary crushing applications.",
                "h5" => "Hydraulic Rotary Feed Distributor:",
                "d5" => "Ensures even distribution of feed material, enhancing throughput capacity and wear life.",
                "h6" => "Combined Hydraulic Power Pack:",
                "d6" => "Facilitates lubrication, CSS adjustment, and tramp iron release for optimal operation.",
                "h7" => "Rugged Construction:",
                "d7" => "Cast top and bottom shells withstand crushing loads for durability.",
                "h8" => "Roller Bearing Design:",
                "d8" => "Lowers frictional losses, optimizing running HP and increasing available power for crushing."
            ),
            ...
            '4' => array(
                'successContent' => "Efficiency Meets Innovation: Elevate Your Screening Experience.",
                'vimage' => "images/leftsideproduct/HSF.webp",
            ...
            '5' => array(
                'successContent' => "Elevate Your Feeding Experience with Sallent: Superior Durability, Precision Engineering, and Unmatched Efficiency. ",
                'vimage' => "images/leftsideproduct/Grizzly-feeder.webp",
            ...
            '6' => array(
                'successContent' => "Efficiently engineered for optimal performance and durability, ensuring reliable results every time.",
                'vimage' => "images/leftsideproduct/Vibrating-screen.webp",
                'h1' => 'Precision Design',
        ...
        //     '0' => array(
        //         'tabledesc' => "Jaw crusher engineering specifications
        //         Equip your facility with our complete Jaw crusher, including motor and pulley, and customize with optional extras like feed chute and drive motor.
        //         ",
        //     ),
        //     '2' => array(
        //         'tabledesc' => "Setting new standards in precision and performance.",
        //     ),
        //     '4' => array(
        //         'tabledesc' => "Elevate screening efficiency with our High Energy Direct Excitation Screen, featuring a unique spring knocker system for optimal performance.",
        //     ),
        //     '5' => array(
        //         'tabledesc' => "Core's Vibrating Grizzly Feeders seamlessly combine scalping and feeding functions, handling high volumes of materials for uniform, controlled feed, and optimizing crushing efficiency in any setup.
        //         ",
        //     ),
        //     '6' => array(
        //         'tabledesc' => "Experience superior material handling with Core Crushing's innovative vibrating screens, designed for efficiency and reliability.",
        //     ),
