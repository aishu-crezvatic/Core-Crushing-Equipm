...
<div class="action" onclick="actionToggle();">
  <span> <i class="fa fa-download" style="font-size:24px"></i>Brochure  </span>
  <ul>
  <form action="sampple-mail.php" method="post" onclick="event.stopPropagation();">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="tel" id="contact_no" name="contact_no" placeholder="" required>
                                    </div>
                                    <div class="col-md-12">
...
<script>
  grecaptcha.ready(function() {
      grecaptcha.execute('6LdtqgIqAAAAAJ-of3Kvj9NLgQ7aIWNeVgg4MWyK', {action: 'homepage'}).then(function(token) {
         console.log(token);
